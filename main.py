...
# اضافه کردن مسیر src به PYTHONPATH برای import لوکال
sys.path.append(os.path.join(os.path.dirname(__file__), "src"))

# ---------- Import کلاس PDFCompressor ---------- 
# از فایل src/pdf_compressor.py
try:
    from pdf_compressor import PDFCompressor
except ImportError:
    print("Warning: PDFCompressor class not found in src/pdf_compressor.py")
    PDFCompressor = None
...
class PDFCompressorApp:
    ...
    def build_gui(self):
        # File Frame
        file_frame = tk.LabelFrame(self.root, text="Select or Drop PDF Files")
        ...
        # DPI Options
        dpi_frame = tk.LabelFrame(self.root, text="DPI Settings")
